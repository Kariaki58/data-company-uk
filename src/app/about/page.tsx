      ...
      <section className="py-20 md:py-28">
        <div className="container grid md:grid-cols-2 gap-12 items-center">
           <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Headquartered in Kent, South East England, we’re proud to represent a region that values innovation, resilience, and strong community ties. We’re especially passionate about partnering with local businesses that share our commitment to growth and sustainability. Our clients’ success is our success—and we’re just getting started.
            </p>
